...
//
//ComponentTemplate::ComponentTemplate(FindingSnackObject* r) {
//    root = r;
//    root->xxx = this;
//    construct();
//}
...
//void ComponentTemplate::enter() {
//
//};
//
//// 객체가 삭제/제거될때 메모리 삭제 등 소멸자 역할을 하게 된다.
//void ComponentTemplate::exit() {};
//
//
...
//void ComponentTemplate::draw() {};
//
//// 사용자의 조작에 어떤 반응을 할것인지를 컨트롤 할 수 있는 부분이다.
//void ComponentTemplate::event() {
//
//};
//
//
...
//void ComponentTemplate::construct() {
//
//}